				...
				<thead>
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<td>${o.orderDate}</td>
						<%
							com.ChengXulin.model.Order o=(com.ChengXulin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ChengXulin.dao.UserDao userDao=new com.ChengXulin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ChengXulin.model.Payment.findByPaymentId(con,n);
							 %>
